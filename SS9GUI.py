...
class SS9GUI(ManagedWindow):
    ...
    def make_procedure(self):
        ...
        procedure.mm2_range = [1, 10, 100][self.inputs.mm2_range.currentIndex()]
        ...
        procedure.mm3_range = [1, 10, 100][self.inputs.mm3_range.currentIndex()]
        ...
        procedure.mm4_range = [1, 10, 100][self.inputs.mm4_range.currentIndex()]
